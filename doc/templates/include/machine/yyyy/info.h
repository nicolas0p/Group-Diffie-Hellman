// EPOS YYYY Run-Time System Information

#ifndef __yyyy_info_h
#define __yyyy_info_h
...
public:
    ...
    // Modifications to this map requires adjustments in MKBI
    struct Boot_Map
    {
        ...
        int extras_offset;
        volatile int cpu_status[Traits<YYYY>::CPUS]; // CPUs initialization status
    };

    // Physical Memory Map (built by SETUP or hard coded for simple machines)
