...
int main()
{
    ...
    Coordinates center_lights9(-1368, -613, 250);
    Coordinates center_lights10(-1510, -613, 250);
    Coordinates center_lights11(-1652, -613, 250);
    Coordinates center_lights14(-1652, -763, 250);
    Coordinates center_lights17(-1652, -914, 250);
    ...
    Coordinates center_outlet13(-1268, -823, -40);
    Coordinates center_outlet15(-1752, -613, -40);
    //Coordinates center_outlet14(-1752, -603, -40);
    //Coordinates center_outlet15(-1752, -613, -40);
    ...
    Region region_lights9(center_lights9, 0, 0, -1);
    Region region_lights10(center_lights10, 0, 0, -1);
    Region region_lights11(center_lights11, 0, 0, -1);
    Region region_lights14(center_lights14, 0, 0, -1);
    Region region_lights17(center_lights17, 0, 0, -1);
    ...
    Region region_outlet13(center_outlet13, 0, 0, -1);
    Region region_outlet15(center_outlet15, 0, 0, -1);
    //Region region_outlet14(center_outlet14, 0, 0, -1);
    //Region region_outlet15(center_outlet15, 0, 0, -1);
    ...
    //Current data_lights9(region_lights9, INTEREST_EXPIRY, INTEREST_PERIOD);
    //Current data_lights10(region_lights10, INTEREST_EXPIRY, INTEREST_PERIOD);
    //Current data_lights11(region_lights11, INTEREST_EXPIRY, INTEREST_PERIOD);
    //Current data_lights14(region_lights14, INTEREST_EXPIRY, INTEREST_PERIOD);
    //Current data_lights17(region_lights17, INTEREST_EXPIRY, INTEREST_PERIOD);
    ...
    //Current data_outlet13(region_outlet13, INTEREST_EXPIRY, INTEREST_PERIOD);
    Current data_outlet15(region_outlet15, INTEREST_EXPIRY, INTEREST_PERIOD);
    //Current data_outlet14(region_outlet14, INTEREST_EXPIRY, INTEREST_PERIOD);
    //Current data_outlet15(region_outlet15, INTEREST_EXPIRY, INTEREST_PERIOD);
    ...
    while(true) {
        ...
        //kout << "Lights 9: " << data_lights9 << " " << data_lights9.time() << " " << endl;
        //kout << "Lights 10: " << data_lights10 << " " << data_lights10.time() << " " << endl;
        //kout << "Lights 11: " << data_lights11 << " " << data_lights11.time() << " " << endl;
        //kout << "Lights 14: " << data_lights14 << " " << data_lights14.time() << " " << endl;
        //kout << "Lights 17: " << data_lights17 << " " << data_lights17.time() << " " << endl;
        //kout << "Outlet 13: " << data_outlet13 << " " << data_outlet13.time() << " " << endl;
        kout << "Outlet 15: " << data_outlet15 << " " << data_outlet15.time() << " " << endl;
        ...
        //print(data_lights9.db_record());
        //print(data_lights10.db_record());
        //print(data_lights11.db_record());
        //data_lights9 = dimmer;
        //data_lights10 = dimmer;
        //data_lights11 = dimmer;
        //data_lights14 = dimmer;
        //data_lights17 = dimmer;
        //data_outlet13 = dimmer;
        data_outlet15 = dimmer;
        kout << "Dimmer set to" << dimmer << endl;
        if(dimmer == 0)
            dimmer = 1;
        else if(dimmer == 1)
            //dimmer = 20;
